    ...
    <div class="container mx-auto">
        <div class="lg:flex lg:space-x-10 lg:p-10">
            ...
            <div class="lg:w-1/2 space-y-5">
                ...
                <div class="border p-5 h-[400px]">
                    <iframe src="https://player.vimeo.com/video/{{ $video->vimeo_video_id }}" width="100%" height="100%" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                </div>
                @endforeach
            </div>
        </div>
